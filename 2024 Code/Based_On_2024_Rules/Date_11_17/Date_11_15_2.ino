...
void loop()
{
  ...
  {
    Straight(80);
    if(Sensor_Left_up_Data[1] == 1 || Sensor_Left_down_Data[8] == 1)//右上
    {
      Step = 1;
    }
    else if(Sensor_Right_up_Data[8] == 1 || Sensor_Right_down_Data[1] == 1)//左上
    {
      Step = 2;
    }
  }
  ...
  else if(Step == 3)
  {
    ...
    else if(Sensor_Left_down_Data[2] == 1 || Sensor_Left_down_Data[3] == 1)
    {
      MC_SPD(-30);
      MD_SPD(-30);
    }
    ...
    else if(Sensor_Left_down_Data[7] == 1 || Sensor_Left_down_Data[6] == 1)
    {
      MC_SPD(50);
      MD_SPD(50);
    }
    else if(Sensor_Left_down_Data[4] == 1 && Sensor_Left_down_Data[5] == 1)
    {
      MC_SPD(0);
      MD_SPD(0);
    }
    ...
    else if(Sensor_Right_down_Data[2] == 1 || Sensor_Right_down_Data[3] == 1)
    {
      MA_SPD(30);
      MB_SPD(30);   
    }
    ...
    else if(Sensor_Right_down_Data[7] == 1 || Sensor_Right_down_Data[6] == 1)
    {
      MA_SPD(-50);
      MB_SPD(-50);
    }
    else if(Sensor_Right_down_Data[4] == 1 && Sensor_Right_down_Data[5] == 1)
    {
      MA_SPD(0);
      MB_SPD(0);
    }    
