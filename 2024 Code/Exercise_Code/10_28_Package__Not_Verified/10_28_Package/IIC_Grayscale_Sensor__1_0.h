...
//存传感器数据
extern bool Sensor_Front_Data[9] = {0};//前方传感器  0
extern bool Sensor_Rear_Data[9] = {0};//后方传感器   1
extern bool Sensor_Left_Data[9] = {0};//左侧传感器   2
extern bool Sensor_Right_Data[9] = {0};//右侧传感器  3
