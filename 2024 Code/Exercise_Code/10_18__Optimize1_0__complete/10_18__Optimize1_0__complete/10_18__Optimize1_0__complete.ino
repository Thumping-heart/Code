...
{
  //感为科技文字朝向自己时的方向
  if(Sensor_Front_Data[1] == 1 || Sensor_Front_Data[2] == 1 || Sensor_Front_Data[3] == 1)//车左移
  {
    SPD_A = 60;
//    SPD_B = -60;
//    SPD_C = 60;
  ...
  else if(Sensor_Front_Data[8] == 1 || Sensor_Front_Data[7] == 1 || Sensor_Front_Data[6] == 1)//车右移
  {
    SPD_A = -60;
//    SPD_B = 60;
//    SPD_C = -60;
...
{
  //感为科技文字朝向自己时的方向
  if(Sensor_Rear_Data[1] == 1 || Sensor_Rear_Data[2] == 1 || Sensor_Rear_Data[3] == 1)//车左移
  {
//    SPD_A = -60;
    SPD_B = 60;
    SPD_C = -60;
//    SPD_D = 60;
  ...
  else if(Sensor_Rear_Data[8] == 1 || Sensor_Rear_Data[7] == 1 || Sensor_Rear_Data[6] == 1)//车右移
  {
//    SPD_A = 60;
    SPD_B = -60;
    SPD_C = 60;
